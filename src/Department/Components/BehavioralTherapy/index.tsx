  ...
  return (
    <section>
      <div className="row py-3">
        ...
        >
          <p className="my-auto">
            SPHECHO provides specialized services primarily clinical psychology,
            psycho educational and neuro-psych rehabilitation – psychological
            assessment, psychotherapies, diagnosis of mental health problems and
            their management. We serve people in all walks of life – children,
            adolescence, adults, and old age.
          </p>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <ul style={{ marginLeft: "14px" }}>
          ...
          <li>
            Behavioral and emotional disorders of children and adolescence
            (ADHD, conduct disorder, social and emotional disorders)
          </li>
          <li>Disorders of adult personality and behavior</li>
          <li>Mood & affective disorder and somatoform disorders</li>
      ...
      <div className="row">
              ...
              >
                ...
                <div className="col-sm-6">
                  ...
                  <ul className="mt-4">
                    ...
                    <li>
                      Outreach programs- school and family visit and other
                      community-based rehabilitation We offer intervention both
                      in individual and group setting
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <ul className="my-4">
          <li>
            Clinical Psychological conditions unlike physical conditions can’t
            be seen. However, they are very important for the healthy
            functioning and wellbeing of the individual.
          </li>
          <li>
            The right intervention at the right time is crucial for growth and
            development.
          </li>
          <li>
            It is emphasized that with conditions like autism, ADHD and other
            childhood disorders, the earlier the intervention, the better the re
            sults.
          </li>
        </ul>
      </div>
      ...
      <div className="row">
        ...
        <div style={{ marginTop: "40px" }}>
          <PurchaseCard
            title="Pediatric Clinical Psychology Services"
            numberOfCard={2}
          />
        </div>
        <div style={{ marginTop: "40px" }}>
          <PurchaseCard
            title="Adult Clinical Psychology Services"
            numberOfCard={2}
          />
        </div>
      </div>
