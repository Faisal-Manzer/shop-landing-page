    ...
    return (
        <>
            <div className='row py-3'>
                ...
                <div className="speechTherapy__img col-sm-6 p-3" style={{ height: '320px' }}>
                ...
                <div className="speechTherapy__info col-sm-6 p-3 d-flex" style={{ fontSize: '14px', fontWeight: '500' }}>
                    <div className="my-auto">
                        <p >Counselling can assist a child or an adult in case of behavioral problems
                            or to cope with dicult circumstances.
                            Our in-house psychologist is very experienced and can recommend
                            the best intervention approach suitable for each individual child. The
                            duration of counselling varies depending on the severity of the di-
                            culties faced.</p>

                        <p>Our platform oers a fun and joyful environment and is very child
                            friendly.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="col-sm-10">
                    <div className="row" style={{ backgroundColor: 'lightgrey', border: '1px solid grey', borderRadius: '20px', padding: '40px' }}>
                        <div className='col-sm-6'>
                            <span style={{ fontSize: '18px', fontWeight: 'bold', marginLeft: '10px' }}>Counselling Services</span>
                            <ul className='mt-4'>
                        ...
                        <div className='col-sm-6'>
                            <span style={{ fontSize: '18px', fontWeight: 'bold', marginLeft: '10px' }}>Counselling is available for individuals presenting</span>
                            <ul className='mt-4'>
