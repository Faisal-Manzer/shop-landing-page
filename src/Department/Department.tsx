    ...
    return (
        <div className='row py-3'>
            ...
            <div className="speechTherapy__info col-sm-6 p-3" style={{ fontSize: '14px', fontWeight: '500' }}>
                <p>An allied health practitioner with training in providing speech therapy
                    services to both pediatric and adult populations is recognized as
                    a speech-language pathologist (SLP) at SPHECHO. Their oerings
                    include evaluation and treatment of communication and swallowing
                    diculties brought on by inherited and acquired medical illnesses.</p>
                <p>Adult swallowing and/or communication diculties frequently
                    result from chronic diseases including Parkinson's disease, dementia,
                    and motor neuron diseases as well as acute ones like stroke and
                    traumatic brain injury. On the other hand, feeding, swallowing,
                    and/or communication issues in children frequently result from underlying
                    medical disorders (i.e., present from birth). These include
                    Cerebral Palsy and Autism Spectrum Disorder (ASD).</p>
                <p>To provide comprehensive treatment and management of the individual's
                    ...
                    educators, etc.) and the individual's family.</p>
            </div>

            <div className="col-sm-12 text-center my-4">
                <span style={{ fontWeight: 'bold' }}>SPHECHO teletherapy services specializes in the following areas:</span>
            </div>

            <div className="col-sm-12">
                <div className="row" style={{ backgroundColor: 'lightgrey', border: '1px solid grey', borderRadius: '20px', padding: '40px' }}>
                    <div className='col-sm-6'>
                        <span style={{ fontSize: '18px', fontWeight: 'bold', marginLeft: '10px' }}>Adult</span>
                        <ul className='mt-4'>
                    ...
                    <div className='col-sm-6'>
                        <span style={{ fontSize: '18px', fontWeight: 'bold', marginLeft: '10px' }}>Pediatric</span>
                        <ul className='mt-4'>
...
const TherapyFees = ({ title }: any) => {
    return (
        <div >
            <div className='row therapyFees' style={{ borderRadius: '40px', backgroundColor: '#e0d3e3' }}>
                <div className='text-center py-3' style={{ borderRadius: '40px 40px 0px 0px', backgroundColor: '#52195e', fontWeight: 'bold' }}>
                ...
                <div style={{ padding: '20px 40px' }}>
                    <div className="row my-5">
                        <div className='col-sm-4' >
                            <FeesCard cardTitle="30 - mins
First Consultation" cardPrice="0" />
                        </div>
                        <div className='col-sm-4'  >
                            <FeesCard cardTitle="45-60 mins
Therapy Session
(A-La-Cart)" cardPrice='20' />
                        </div>
                        <div className='col-sm-4' >
                            <FeesCard cardTitle="45-60 mins
Therapy Session
        ...
        <div className="feesCard">
            ...
            <div className="feesCard__section">
                ...
                <div className='feesCard__footer'>
                    <button className='feesCard__getStartedBtn'>Get Started</button>
                </div>
            </div>
        </div>
    )
...
const MoreFeesCard = () => {
    return (
        <div className="feesCard">
            <div className='feesCard__header'>
                <i className="bi bi-clock" style={{ fontSize: '35px' }}></i>
                <span style={{ fontSize: '18px' }}>More Therapy
                    Sessions</span>
            </div>

            <div className="feesCard__section">
                <div className='feesCard__middle'>
                    <h4 style={{ fontWeight: 'bold' }}>View our
                        packages below</h4>
                    <h1>
                        <span style={{ fontSize: '20px', fontWeight: 'bold' }}></span>
